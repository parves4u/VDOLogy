...
const TermsContentPrivacy = () => {
  ...
  return (
    <div>
      {/* Helmet for SEO */}
      <Helmet>
        <title>Privacy Policy - VDOLogy</title>
        <meta
          name="description"
          content="Read VDOLogy's privacy policy regarding data collection, use, and storage to ensure your privacy rights are respected."
        />
        <meta
          name="keywords"
          content="VDOLogy, Privacy Policy, Data Protection, Personal Information, Data Usage"
        />
        <meta name="robots" content="index, follow" />
        <meta name="author" content="VDOLogy Team" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <link rel="canonical" href="https://www.vdology.com/privacy-policy" />
      </Helmet>
